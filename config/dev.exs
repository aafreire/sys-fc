...
config :sys_fc, SysFc.Repo,
  ...
  database: System.get_env("POSTGRES_DB", "sys_fc_dev"),
  stacktrace: true,
...
config :sys_fc, SysFcWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "n/da2FTk8/1u2jFZA6HPX05NDesfi/PyRCvQ98q0DlVwyq40iqBX8illoerOjBzK",
  watchers: []
...
config :sys_fc, :jwt_secret, "dev_jwt_secret_key_for_development_only_32_chars!"
